...
//            logger.warn("result at " + i + " is " + current);
    ...
    public void testRefConfidenceBasic(final int nReads, final int extension) {
        ...
        final List<VariantContext> contexts = model.calculateRefConfidence(data.getRefHap(), haplotypes, data.getPaddedRefLoc(), data.getActiveRegion(), likelihoods, ploidyModel, calls, false, null, -1, -1);
