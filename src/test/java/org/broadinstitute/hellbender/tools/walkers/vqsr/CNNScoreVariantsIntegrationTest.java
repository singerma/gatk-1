...
public class CNNScoreVariantsIntegrationTest extends CommandLineProgramTest {
    ...
    public void testOnMitochondria() throws IOException{
        ...
        final ArgumentsBuilder argsBuilder = new ArgumentsBuilder();
        argsBuilder.addArgument(StandardArgumentDefinitions.VARIANT_LONG_NAME, mitoVcf)
                .addArgument(StandardArgumentDefinitions.REFERENCE_LONG_NAME, largeFileTestDir +"mtDNA.fa")
                .addArgument("architecture", architecture1D)
                .addArgument(StandardArgumentDefinitions.ADD_OUTPUT_VCF_COMMANDLINE, "false");
